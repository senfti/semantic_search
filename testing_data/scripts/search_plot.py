...
full = np.asarray(timesf)
stupid = np.asarray(timess)
lfull = np.asarray(lengthf)
lstupid = np.asarray(lengths)

print np.mean(full), np.std(full), np.mean(stupid), np.std(stupid)
print np.mean(lfull), np.std(lfull), np.mean(lstupid), np.std(lstupid)
