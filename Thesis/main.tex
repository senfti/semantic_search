...
\newcommand{\mybiblatexstyle}{ieeetr}
...
%% general metadata:
\newcommand{\myauthor}{Thomas Senfter}  %% also used for PDF metadata (hyperref)
\newcommand{\myauthorwithexistingtitles}{\myauthor{}, Bsc}  %% including
                                %% university degree already held
                                %% (BSc, MSc, ...)
\newcommand{\mytitle}{Active Object Search in Unknown Open Environments}  %% also used for PDF metadata (hyperref)
...
\newcommand{\myinstitutehead}{Univ.-Prof. Dipl.-Ing. Dr.techn. Wolfgang Slany} %% head of institute
\newcommand{\mysupervisor}{Assoc.Prof. Dipl.-Ing. Dr.techn. Gerald Steinbauer} %% your supervisor
\newcommand{\myevaluator}{Assoc.Prof. Dipl.-Ing. Dr.techn. Gerald Steinbauer} %% your evaluator
...
\newcommand{\myid}{01230572} %% Matrikelnummer
...
\newcommand{\hlplanner}{high{\_}level{\_}planner}
\newcommand{\llplanner}{low{\_}level{\_}planner}

\lstset{
   basicstyle=\fontsize{11}{13}\fontfamily{lmtt}\fontseries{lc}\selectfont
}
