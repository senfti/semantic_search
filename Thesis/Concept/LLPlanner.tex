...
\begin{figure}[h]
 ...
 \caption[Blocked doorway]{Doorway (green arrow) is blocked by a virtual obstacle (blue) during exploration}
...
\begin{equation} \label{objfunc3}
 P(o|\mathbf{p})=1-\prod_{c \in cells\;in\;room} (1-P(Obj_{c}^{o}|I_{1:t}, \mathbf{x}_{1:t})P(vis_c|\mathbf{p})P(det_c|\mathbf{p}))
\end{equation}
...
\begin{figure}[h]
 ...
 \caption[Best directions to view cell]{Directions from the nearest accessible cell for every cell outside of the border (yellow arrows), accessible area (purple), border of free space (orange) and 2D grid map in the background} 
