...
The goal of this thesis is to find an object of a certain object type in an indoor environment. To improve the search strategy commonsense knowledge should be used. The most important thing to know about indoor environments is that they can be segmented into rooms. Rooms are of a certain type, e.g. living room, or an assambly of room types, e.g. a living room with a kitchenette. Rooms are seperated by walls and are usually only connected by narrow doorways. The other major chunk of commonsense knowledge is information about the correlation between room types and objects located in this room. Therefore the selection of the correct room to search is the most important part of finding a good search path.
