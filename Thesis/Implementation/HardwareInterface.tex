...
The hokuyo{\_}node provides access to the LIDAR. It publishes a laser scan message, which contains an array of range measurements in polar coordinates and the information about the angle range and the resolution of the laser scan.
