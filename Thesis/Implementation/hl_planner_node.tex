...
The generated plan only contains the order in which the rooms are searched. The generation of the high-level task is done according to Section \ref{HLTaskGen}. If the plan is empty, the search is finished and no object was found.
