...
Additionally to the search space $\psi$ the probability distribution of an object of the target object class in the search space $P_{\psi}(o)$ is important for the search strategy. 
