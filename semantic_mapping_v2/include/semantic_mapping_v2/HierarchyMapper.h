...
class HierarchyMapper{
  ...
  public:
    ...
    std::vector<ObjectMap> getCompleteObjMap(const std::vector<cv::Mat_<float>>& room_base_obj_maps, const std::vector<ObjectMap>& obj_map, const ObjectMap& occ_map, int obj = -1);
